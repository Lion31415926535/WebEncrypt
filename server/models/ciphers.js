...
export async function createCipher(userId, algorithm, cipherData) {
    const result = await pool.query(
        "INSERT INTO ciphers (user_id, algorithm, cipher_data) VALUES ($1, $2, $3) RETURNING *",
        [userId, algorithm, cipherData]);
